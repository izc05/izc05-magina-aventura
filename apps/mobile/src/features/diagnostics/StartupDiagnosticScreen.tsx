  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.card}>
        ...
        <Text style={styles.title}>ARRANQUE OK</Text>
        <Text style={styles.body}>
          Variante startup-test-{startupDiagnosticVariant}. Esta pantalla evita catálogo, mapas y recuperación de aventura.
        </Text>
        <Text style={styles.phase}>Última pantalla: home-mounted</Text>
      </View>
    </SafeAreaView>
  );
}
